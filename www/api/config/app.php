<?php
$GLOBALS['lpconfig']['site_name'] = 'AIChain';
$GLOBALS['lpconfig']['site_domain'] = 'AIChain';
...
if (c('mode') == 'pro') {
    // 本地测试环境配置
    $GLOBALS['lpconfig']['site_base_url'] = 'http://api.aichain.work/';
    $GLOBALS['lpconfig']['buildeverytime'] = false;
    $GLOBALS['lpconfig']['image_allowed_domain'] = ['aichain.work','api.aichain.work'];   // 图片链接可以允许的域名
    ...
    $GLOBALS['lpconfig']['default_avatar_url'] = 'http://bot.aichain.work/image/avatar.jpg';
} else {
    // 本地测试环境配置
